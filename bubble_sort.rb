...
#   while swapped
#     swapped = false
#     # .times loop starts at 0, so iterator block variable 'position' serves as an index of the current element in arr
#     (input_array.length - 1).times do |position|
#       if input_array[position] > input_array[position + 1]
#         input_array[position], input_array[position + 1] = input_array[position + 1], input_array[position]
#         swapped = true
#       end
#     end
#   end
